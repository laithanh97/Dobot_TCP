...
namespace Dobot_TCP.com.dobot.api
{
    class Feedback : DobotClient
    {
        ...
        private void ParseData(byte[] buffer)
        {
            ...
            for (int i = 0; i < feedbackData.MotorTemperatures.Length; ++i)
            {
                feedbackData.MotorTemperatures[i] = BitConverter.ToDouble(buffer, iStartIndex);
                iStartIndex += 8;
            }
            ...
            for (int i = 0; i < feedbackData.UserValue.Length; ++i)
            {
                feedbackData.UserValue[i] = BitConverter.ToDouble(buffer, iStartIndex);
                iStartIndex += 8;
            }
            ...
            for (int i = 0; i < feedbackData.TargetQuarternion.Length; ++i)
            {
                feedbackData.TargetQuarternion[i] = BitConverter.ToDouble(buffer, iStartIndex);
                iStartIndex += 8;
            }

            for (int i = 0; i < feedbackData.ActualQuarternion.Length; ++i)
            {
                feedbackData.ActualQuarternion[i] = BitConverter.ToDouble(buffer, iStartIndex);
                iStartIndex += 8;
            }
