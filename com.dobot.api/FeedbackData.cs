...
namespace Dobot_TCP.com.dobot.api
{
    class FeedbackData
    {
        ...
        public double[] MotorTemperatures = new double[6];//关节温度
        ...
        public double[] UserValue = new double[6];//用户坐标值
        ...
        public double[] TargetQuarternion = new double[4]; //[qw,qx,qy,qz] 目标四元数
        public double[] ActualQuarternion = new double[4];//[qw,qx,qy,qz]  实际四元数
